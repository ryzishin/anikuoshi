  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center gap-3 px-4 sm:px-6">
        ...
        <Link href="/" aria-label="AniKuoshi home" className="flex items-center">
          <BrandedLogo />
        </Link>
  ...
  return (
    <div ref={wrapRef} className="relative min-w-0 flex-1 sm:flex-none" role="combobox" aria-expanded={open && Boolean(value.trim())} aria-haspopup="listbox" aria-controls="quick-suggestions">
      ...
      <input
        ...
        className="h-9 w-full rounded-full border border-border/70 bg-muted/60 pl-9 pr-3 text-sm outline-none transition-all placeholder:text-muted-foreground focus:border-primary/50 focus:bg-background sm:w-44 sm:focus:w-64 lg:w-56 lg:focus:w-72"
      />
      <div
        id="quick-suggestions"
        role="listbox"
        className={`absolute left-0 right-0 top-11 z-50 max-h-80 overflow-y-auto rounded-xl border border-border bg-popover p-1.5 shadow-xl ${
