    ...
    <div className="relative">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-20 pt-28 sm:px-6">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button asChild size="lg" className="brand-gradient h-12 border-0 px-7 text-base text-white shadow-xl glow">
                <Link href="/home">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, i) => {
            ...
            return (
              ...
              >
                <div className="brand-gradient mb-4 flex h-10 w-10 items-center justify-center rounded-xl text-white shadow-md">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-24 sm:px-6" data-aos="fade-up">
        <div className="relative overflow-hidden rounded-3xl border border-border/70 p-10 text-center sm:p-16">
          <div className="brand-gradient absolute inset-0 opacity-[0.13]" aria-hidden />
          <div className="brand-gradient absolute -top-24 left-1/2 h-64 w-[36rem] -translate-x-1/2 rounded-full opacity-20 blur-3xl" aria-hidden />
          ...
          <div className="relative mt-8 flex flex-wrap justify-center gap-3">
            <Button asChild size="lg" className="brand-gradient h-12 border-0 px-8 text-white">
