    ...
    return (
      <div className="mx-auto max-w-md px-4 py-24 text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <Button asChild className="brand-gradient border-0 text-white"><Link href="/login">Sign in</Link></Button>
        ...
        <CardContent className="flex flex-col items-start gap-5 p-6 sm:flex-row sm:items-center">
          ...
          >
            {user.avatarUrl ? (
              ...
              <span className="brand-gradient flex h-full w-full items-center justify-center text-2xl font-black text-white">
          ...
          <Card className="border-border/70 bg-card/70 backdrop-blur">
            ...
            <CardContent className="space-y-3">
              <div className="flex gap-2">
                ...
                <Button onClick={saveName} disabled={savingName || name.trim() === user.username} className="brand-gradient border-0 text-white">
              ...
              >
                <span>
                  ...
                  <span className="text-xs text-muted-foreground">
                    Title language, default server, playback toggles, theme &amp; accent
                  </span>
                </span>
                ...
                <Link key={li.animeKey} href={`/anime/${encodeURIComponent(li.animeKey)}`} className="group">
                  <div className="relative">
                    {li.poster ? (
                      ...
                      <div className="brand-gradient aspect-[2/3] w-full rounded-lg opacity-60" />
                    )}
